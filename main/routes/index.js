...
(function() {
  var async, blogs_object, features_object, html_minifier, os, render_views, url, _;
  ...
  features_object = {
    one_click_rsvp: {
      ...
      additional_images: ['RSVPWidget_1', 'RSVPWidget_2', 'RSVPWidget_3']
    },
    sms_communication: {
      ...
      additional_images: ['SMSCommunication_1']
    },
    ...
    promoter_ratings: {
      ...
      additional_images: ['PromoterRating_1']
    },
    ...
    team_management: {
      ...
      additional_images: ['TableManagement_1', 'TableManagement_2', 'TableManagement_3']
    },
    tablet_and_mobile: {
      ...
      additional_images: ['TabletMobile_1', 'TabletMobile_2', 'TabletMobile_3', 'TabletMobile_4', 'TabletMobile_5', 'TabletMobile_6', 'TabletMobile_7']
    },
    promotional_staff_management: {
      ...
      additional_images: ['PromotionalStaffManagement_1']
    },
    host_checkin_tool: {
      ...
      additional_images: ['CheckIn_1', 'CheckIn_2', 'CheckIn_3', 'CheckIn_4']
    },
    email_marketing: {
  ...
  exports.blog_all = function(req, res) {
    var blog_keys, entries, index, key, methods, num, _fn, _i;
    ...
    if (!(blog_keys[index * 3] != null)) {
      render_views(req, res, 'view_404', {}, 404);
      return;
    }
    entries = {};
    for (num = _i = 0; _i <= 2; num = _i += 1) {
      if (blogs_object[blog_keys[index * 3 + num]] != null) {
        entries[blog_keys[index * 3 + num]] = blogs_object[blog_keys[index * 3 + num]];
      }
    }
    methods = [];
    _fn = function(key, res, entries) {
      return methods.push(function(callback) {
        return res.render('blogs/view_blogs_' + key, {
          entries: entries
        }, function(err, html) {
  ...
  exports.blog_entry = function(req, res) {
    if (blogs_object[req.params.entry] != null) {
      return res.render('blogs/view_blogs_' + req.params.entry, {}, function(err, html) {
        return render_views(req, res, 'view_blog_post', _.extend(blogs_object[req.params.entry], {
          html: html
        }));
      });
    } else {
